...
const T = {
  ru: {
    ...
    'lb.lead': 'Очки начисляются за добычу руд, рыбалку и убийство мобов и боссов. Топ-игроки сезона получат уникальный лут и место в Зале Славы.',
  ...
  en: {
    ...
    'lb.lead': 'Points are earned for mining ores, fishing, and killing mobs or bosses. Top players each season win unique loot and a spot in the Hall of Fame.',
    'lb.alltime': 'All-time',
    'lb.today': 'Today',
