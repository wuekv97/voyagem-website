...
const T = {
  ru: {
    ...
    'mobs.fatling_tag': 'мини-босс',
    'mobs.fatling_desc': 'Огромный страж сокровищниц с тяжёлой поступью. Медленный, но один удар своей булавой может стоить вам половины здоровья и нескольких драгоценных секунд.',
    'mobs.crusher_tag': 'босс',
    'mobs.crusher_desc': 'Финальный босс кристальных подземелий. Швыряет цепями на расстоянии, призывает помощь из тёмных закоулков и не даёт перевести дух. Победителя ждёт лучший лут сезона.',
    'mobs.stat_hp': 'HP',
    'mobs.stat_dmg': 'Урон',
    'mobs.stat_xp': 'XP',
    'mobs.drops': 'Дроп',
  ...
  en: {
    ...
    'mobs.fatling_tag': 'mini-boss',
    'mobs.fatling_desc': 'A massive treasure-vault guardian with a heavy gait. Slow on his feet, but one mace swing can cost you half your health and several precious seconds.',
    'mobs.crusher_tag': 'boss',
    'mobs.crusher_desc': 'The final boss of the crystal dungeons. Hurls chains from range, summons help from the dark corners, and never lets you catch your breath. The reward is the season\'s best loot.',
    'mobs.stat_hp': 'HP',
    'mobs.stat_dmg': 'DMG',
    'mobs.stat_xp': 'XP',
    'mobs.drops': 'Drops',
